...
Ejercicio54() {
 ...
 Ejercicio56() {
    ...
    num = arreglo.map(Number);
    longitud = num.length;
    //OTRA COSITA MAS, RECUERDA QUE PARA INDICAR QUE QUEREMOS EMPEZAR DESDE EL ULTIMO VALOR DEL ARREGLO DEBEMOS SI O SI PONER -1 EN EL RESULTADO DE LONGUITUD 
    ...
    for (i = longitud-1; i >= 0; i--) {
        //OJO AQUI DE LO QUE HICE, QUE DENTRO DEL CICLO FOR PARA GUARDAR LOS DATOS DEL ARREGLO INVERTIDO LO QUE HICE FUE ASIGNARLE A LA SEGUNDA VARIABLE ARREGLO 2
...
Ejercicio57() {
 ...
 Ejercicio58() {
    document.getElementById("Respuesta58").innerHTML = "Hola que te tengas un buen dia :)";
}
